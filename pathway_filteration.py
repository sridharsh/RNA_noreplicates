...
def main():
    ...
    files_HT = ["HT_c2_neg.xls", "HT_c2_pos.xls","HT_c3_neg.xls","HT_c3_pos.xls","HT_h_neg.xls","HT_h_pos.xls", "HT_c5_neg.xls", "HT_c5_pos.xls"]
    files_NT = ["NT_c2_neg.xls","NT_c2_pos.xls","NT_c3_neg.xls","NT_c3_pos.xls","NT_h_neg.xls","NT_h_pos.xls", "NT_c5_neg.xls", "NT_c5_pos.xls"]

    for i in range(len(files_HT)):

        print(files_HT[i], files_NT[i])
        data_load = common_pathways(files_HT[i], files_NT[i], files_HT[i].replace(".xls", "_")+files_NT[i].replace(".xls", ".txt"))
